...
//  * - Leaves retry/backoff hooks in place if you want to grow them later
//  */
...
//   /** Optional allow network/browser caching for analytics requests. */
//   cache?: boolean;
// };

// export async function send(req: TransportRequest): Promise<Response> {
//   const { method, url, body, maxBeaconBytes, signal, cache } = req;
...
//     headers,
//     body: strippedBody,
//     maxBeaconBytes: req.maxBeaconBytes,
...
//   // Prepare payload
//   const serialized =
//     typeof strippedBody === 'string' ? strippedBody : (strippedBody == null ? '' : JSON.stringify(strippedBody));
...
//       }
//       // If beacon offloads but returns false, fall through to fetch
//     }
//   }
